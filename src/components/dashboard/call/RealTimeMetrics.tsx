      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="p-4 rounded-lg bg-gray-50">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-sm font-medium text-black">Sentiment</span>
          </div>
          <div className="text-lg font-semibold text-black capitalize">
            {customerSentiment}
          </div>
        </div>
        ...
        <div className="p-4 rounded-lg bg-gray-50">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-sm font-medium text-black">Talk Ratio</span>
          </div>
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-black">{talkRatio.agent}%</span>
          </div>
        </div>
        ...
        <div className="p-4 rounded-lg bg-gray-50">
          ...
          <div className="text-lg font-semibold text-black">High</div>
        </div>
      </div>
    </div>
  );
